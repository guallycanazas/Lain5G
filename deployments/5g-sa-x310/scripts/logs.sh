...
service="${SERVICE:-}"
case "$service" in ""|mongo|nrf|ausf|udm|udr|pcf|upf|smf|amf|ims-database|ims-provisioner|pcscf|icscf|scscf|dns|gnb-x310) ;; *) echo "Unknown service: $service" >&2; exit 2;; esac

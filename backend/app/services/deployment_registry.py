...
DEPLOYMENTS: dict[str, DeploymentDefinition] = {
    ...
    "4g-lte-x310": DeploymentDefinition(
        ...
        description="Controlled LTE RF with Open5GS EPC, always-on compact IMS infrastructure, srsRAN eNB, and compatible USRP hardware.",
        ...
        validation_checks=["hardware_detected", "ethernet_link", "uhd_available", "uhd_fpga_compatible", "epc_services", "mme_ready", "ims_services", "rf_preflight", "enb_started", "s1_setup", "auto_stop", "logs_captured"],
        rf_capable=True,
    ...
    "5g-sa-x310": DeploymentDefinition(
        ...
        description="Controlled 5G SA RF with Open5GS, always-on compact IMS infrastructure, srsRAN Project gNB, and compatible USRP hardware.",
        ...
        validation_checks=["hardware_detected", "uhd_available", "core_services", "amf_ready", "ims_services", "rf_preflight", "gnb_started", "ng_setup", "auto_stop", "logs_captured"],
        rf_capable=True,
    ...
    "5g-nsa-x310": DeploymentDefinition(
        ...
        description="Experimental srsRAN 4G EN-DC integration with LTE and NR for controlled laboratory evaluation.",

...
DEPLOYMENTS: dict[str, DeploymentDefinition] = {
    ...
    "4g-lte-x310": DeploymentDefinition(
        ...
        description="Controlled LTE RF with Open5GS EPC, srsRAN eNB, and compatible USRP hardware.",
        ...
        rf_capable=True,
        expected_services=["mongo", "mme", "hss", "sgwc", "sgwu", "pgwc", "pgwu", "pcrf", "enb-x310"],
        log_services=["mongo", "mme", "hss", "sgwc", "sgwu", "pgwc", "pgwu", "pcrf", "enb-x310"],
    ...
    "5g-sa-x310": DeploymentDefinition(
        ...
        description="Controlled 5G SA RF with Open5GS, srsRAN Project gNB, and compatible USRP hardware.",

...
DEPLOYMENTS: dict[str, DeploymentDefinition] = {
    "5g-sa": DeploymentDefinition(
        id="5g-sa",
        name="5G - UERANSIM Simulation",
        description="Software-only 5G SA with Open5GS and UERANSIM gNB/UE, including a data PDU session; VoNR is not included.",
    ...
    "4g-lte-sim": DeploymentDefinition(
        id="4g-lte-sim",
        name="4G - srsRAN ZMQ Simulation",
        description="Software-only LTE with Open5GS EPC, srsENB, and srsUE over ZMQ; IMS and VoLTE are not included.",
    ...
    "5g-vonr-sim": DeploymentDefinition(
        ...
        mode="simulation",
        supported_actions=["start", "stop", "restart", "status", "logs", "validate"],
        validation_checks=["mongo", "nrf", "amf", "smf", "upf", "ausf", "udm", "udr", "pcf", "ng_setup", "ue_registration", "pdu_internet", "pdu_ims", "ue_internet_ip", "ue_ims_ip", "ue_internet_tun", "ue_ims_tun", "data_ping", "ims_database", "pcscf", "icscf", "scscf", "ims_dns", "pcscf_reachable_over_ims", "sip_register"],
        expected_services=["mongo", "nrf", "amf", "smf", "upf", "ausf", "udm", "udr", "pcf", "gnb", "ue", "ims-database", "pcscf", "icscf", "scscf", "dns"],
        log_services=["mongo", "nrf", "amf", "smf", "upf", "ausf", "udm", "udr", "pcf", "gnb", "ue", "ims-database", "pcscf", "icscf", "scscf", "dns", "sip-register"],
        catalog_visible=False,
    ),
    "4g-lte-x310": DeploymentDefinition(
        id="4g-lte-x310",
        name="4G - Guarded LTE RF",
        description="Controlled LTE RF with Open5GS EPC, always-on compact IMS infrastructure, srsRAN eNB, and compatible USRP hardware; IMS registration and VoLTE calls are not validated.",
        ...
        validation_checks=["hardware_detected", "ethernet_link", "uhd_available", "uhd_fpga_compatible", "epc_services", "mme_ready", "ims_services", "ims_registration", "volte_call", "rtp_media", "rf_preflight", "enb_started", "s1_setup", "auto_stop", "logs_captured"],
        rf_capable=True,
        expected_services=["mongo", "mme", "hss", "sgwc", "sgwu", "pgwc", "pgwu", "pcrf", "ims-database", "pcscf", "icscf", "scscf", "dns", "enb-x310"],
        log_services=["mongo", "mme", "hss", "sgwc", "sgwu", "pgwc", "pgwu", "pcrf", "ims-database", "ims-provisioner", "pcscf", "icscf", "scscf", "dns", "enb-x310"],
    ...
    "5g-sa-x310": DeploymentDefinition(
        id="5g-sa-x310",
        name="5G - Guarded SA RF",
        description="Controlled 5G SA RF with Open5GS, always-on compact IMS infrastructure, srsRAN Project gNB, and compatible USRP hardware; IMS registration and VoNR calls are not validated.",
        ...
        validation_checks=["hardware_detected", "uhd_available", "core_services", "amf_ready", "ims_services", "ims_registration", "vonr_call", "rtp_media", "rf_preflight", "gnb_started", "ng_setup", "auto_stop", "logs_captured"],
        rf_capable=True,
        expected_services=["mongo", "nrf", "ausf", "udm", "udr", "pcf", "upf", "smf", "amf", "ims-database", "pcscf", "icscf", "scscf", "dns", "gnb-x310"],
        log_services=["mongo", "nrf", "ausf", "udm", "udr", "pcf", "upf", "smf", "amf", "ims-database", "ims-provisioner", "pcscf", "icscf", "scscf", "dns", "gnb-x310"],
    ...
    "5g-nsa-x310": DeploymentDefinition(
        ...
        description="Experimental srsRAN 4G EN-DC integration with LTE and NR; commercial UE compatibility is not validated.",

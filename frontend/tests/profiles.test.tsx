...
const summaries = [{ profile: '5g-sa', rf_capable: false, rf_allowed: false }, { profile: '5g-vonr', rf_capable: false, rf_allowed: false }, { profile: '4g-lte-sim', rf_capable: false, rf_allowed: false }, { profile: '4g-volte-sim', rf_capable: false, rf_allowed: false }, { profile: '4g-lte-x310', rf_capable: true, rf_allowed: false }, { profile: '5g-sa-x310', rf_capable: true, rf_allowed: false }, { profile: '5g-nsa-x310', rf_capable: true, rf_allowed: false }];
...
describe('Deployment configuration', () => {
  ...
  it('renders structured editable fields without a raw YAML editor', async () => {
    ...
    expect(screen.getByText('4G LTE data and IMS signaling lab')).toBeInTheDocument();
    expect(screen.getByText('5G SA data and IMS signaling lab')).toBeInTheDocument();

    ...
    <section className="landing-hero" id="top">
      <div className="landing-container landing-hero-grid">
        <motion.div className="landing-hero-copy" initial={{ opacity: 0, x: -24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: .7 }}>
          ...
          <p className="landing-copy mx-auto mb-8 max-w-[520px] lg:mx-0">Build and study isolated mobile data networks with a reproducible stack for RAN, core, subscribers, orchestration, and validation. Start in software, then move to guarded SDR paths when your lab is ready.</p>

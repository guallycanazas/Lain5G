  ...
  return (
    <figure className="architecture-visual">
      <img
        ...
        width="1536"
        height="1024"
        alt="Illustrated private mobile network with radio access, core and IMS services, a SIM, and a laboratory handset"
        decoding="async"
        fetchPriority="high"
      />
      <figcaption>
        {['SDR + RAN', 'Open5GS core', 'IMS services', 'Lab UE + SIM'].map((label) => <span key={label}>{label}</span>)}

...
This assessment distinguishes publication of the OpenLain5G source repository
...
The `1.1.3` release boundary is source-only. Existing registry artifacts are
...
| --- | --- | --- | --- |
| OpenLain5G first-party source | Ready | `LICENSE` contains the MIT grant; third-party configuration is separately identified. | Preserve the MIT notice and `THIRD_PARTY_NOTICES.md` in source distributions. |
